...
/**
 * SouthAfricaNidMatch2FullNameField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class SouthAfricaNidMatch2FullNameField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SouthAfricaNidMatch2FullNameField';
     ...
     * Sets outcome
     *
     * @param string|null $outcome The outcome of comparing the submitted full name to the issuer record.              Possible values: - Exact Match - Partial Match - Transposed - No Match - Not Returned
     *
     * @return self
     */
