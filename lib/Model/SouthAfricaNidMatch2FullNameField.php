...
class SouthAfricaNidMatch2FullNameField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets outcome
     *
     * @param string $outcome The outcome of comparing the submitted full name to the issuer record.              Possible values: - Exact Match - Partial Match - Transposed - No Match - Not Returned
     *
     * @return self
     */
