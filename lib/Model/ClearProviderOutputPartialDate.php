...
/**
 * ClearProviderOutputPartialDate Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class ClearProviderOutputPartialDate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ClearProviderOutputPartialDate';
     ...
     * Sets day
     *
     * @param int|null $day The day of the month.
     *
     * @return self
     */
     ...
     * Sets month
     *
     * @param int|null $month The month number, where January is 1.
     *
     * @return self
     */
