...
/**
 * KenyaNidLookup3Input Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class KenyaNidLookup3Input implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'KenyaNidLookup3Input';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['id_number']) > 9)) {
            $invalidProperties[] = "invalid value for 'id_number', the character length must be smaller than or equal to 9.";
        }
        ...
        if (!preg_match("/^\\d*$/", $this->container['id_number'])) {
            $invalidProperties[] = "invalid value for 'id_number', must be conform to the pattern /^\\d*$/.";
        }
    ...
    public function setIdNumber($id_number)
    {
        ...
        if ((mb_strlen($id_number) > 9)) {
            throw new \InvalidArgumentException('invalid length for $id_number when calling KenyaNidLookup3Input., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($id_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id_number when calling KenyaNidLookup3Input., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^\\d*$/", ObjectSerializer::toString($id_number)))) {
            throw new \InvalidArgumentException("invalid value for \$id_number when calling KenyaNidLookup3Input., must conform to the pattern /^\\d*$/.");
        }
