...
/**
 * SouthAfricaNidMatch2NationalIdNumberField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class SouthAfricaNidMatch2NationalIdNumberField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SouthAfricaNidMatch2NationalIdNumberField';
     ...
     * Sets outcome
     *
     * @param string|null $outcome The outcome of verifying the national ID number.              Possible values: - Verified - Not Verified - Not Done - Issuer Unavailable - Not Returned
     *
     * @return self
     */
