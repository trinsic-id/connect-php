...
/**
 * SouthAfricaNidMatch2SexField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class SouthAfricaNidMatch2SexField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SouthAfricaNidMatch2SexField';
     ...
     * Sets outcome
     *
     * @param string|null $outcome The outcome of comparing the submitted sex to the issuer record.              Possible values: - Exact Match - No Match - Not Provided - Not Returned
     *
     * @return self
     */
