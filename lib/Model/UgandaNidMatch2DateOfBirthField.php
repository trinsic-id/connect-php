...
/**
 * UgandaNidMatch2DateOfBirthField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class UgandaNidMatch2DateOfBirthField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UgandaNidMatch2DateOfBirthField';
     ...
     * Sets outcome
     *
     * @param string|null $outcome The outcome of comparing the submitted date of birth with NIRA database.              For Uganda match, partial or transposed outcomes are not used; matching is exact or no match.              Possible values: - Exact Match - No Match - Not Returned
     *
     * @return self
     */
