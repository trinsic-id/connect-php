...
/**
 * PhilippinesPhilsysMatchProviderOutput Class Doc Comment
 *
 * @category Class
 ...
 */
class PhilippinesPhilsysMatchProviderOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PhilippinesPhilsysMatchProviderOutput';
     ...
     * Sets middle_name
     *
     * @param string|null $middle_name The individual's middle name, if provided.
     *
     * @return self
     */
     ...
     * Sets suffix
     *
     * @param string|null $suffix The individual's name suffix, if provided.
     *
     * @return self
     */
     ...
     * Sets birth_date
     *
     * @param \DateTime|null $birth_date The individual's birth date.
     *
     * @return self
     */
