...
/**
 * AlaskaMobileIdProviderOutput Class Doc Comment
 *
 * @category Class
 ...
 */
class AlaskaMobileIdProviderOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AlaskaMobileIdProviderOutput';
     ...
     * Sets raw_mdl_output
     *
     * @param \Trinsic\Api\Model\MdlOutput|null $raw_mdl_output The raw output of the 18013-7 mDL exchange performed through Alaska Mobile ID.
     *
     * @return self
     */
