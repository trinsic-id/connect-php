...
class NigeriaNinMatch2PhoneNumberField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets input_value
     *
     * @param string $input_value The phone number as submitted for this check.              Format: - International E.164
     *
     * @return self
     */
     ...
     * Sets outcome
     *
     * @param string $outcome The outcome of comparing the submitted phone number to the issuer record.              Possible values: - Exact Match - No Match - Not Provided - Not Returned
     *
     * @return self
     */
