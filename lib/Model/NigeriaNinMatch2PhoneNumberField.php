...
/**
 * NigeriaNinMatch2PhoneNumberField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class NigeriaNinMatch2PhoneNumberField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NigeriaNinMatch2PhoneNumberField';
     ...
     * Sets input_value
     *
     * @param string|null $input_value The phone number as submitted for this check.              Format: - International E.164
     *
     * @return self
     */
     ...
     * Sets outcome
     *
     * @param string|null $outcome The outcome of comparing the submitted phone number to the issuer record.              Possible values: - Exact Match - No Match - Not Provided - Not Returned
     *
     * @return self
     */
