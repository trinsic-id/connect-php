...
/**
 * IndonesiaDukcapilMatchDateOfBirthField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class IndonesiaDukcapilMatchDateOfBirthField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IndonesiaDukcapilMatchDateOfBirthField';
     ...
     * Sets outcome
     *
     * @param float|null $outcome The provider assessment result for the submitted date of birth.              Local integration code expects the provider to return 0 or 1 for this assessment.
     *
     * @return self
     */
