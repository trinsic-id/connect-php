...
/**
 * Iso180132BiometricDataBlockProduct Class Doc Comment
 *
 * @category Class
 ...
 */
class Iso180132BiometricDataBlockProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Iso180132BiometricDataBlockProduct';
    ...
    {
        $this->setIfExists('product_owner', $data ?? [], null);
    ...
    {
        return $this->container['product_owner'];
    }
