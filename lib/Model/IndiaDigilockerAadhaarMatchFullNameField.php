...
class IndiaDigilockerAadhaarMatchFullNameField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets input_value
     *
     * @param string $input_value The full name string submitted for this check, as provided in the match input.
     *
     * @return self
     */
     ...
     * Sets outcome
     *
     * @param float $outcome Full-name similarity score from the DigiLocker match result for this session.              Format: - Between 0.0 to 1.0, where higher values indicate closer agreement with the Aadhaar record.
     *
     * @return self
     */
