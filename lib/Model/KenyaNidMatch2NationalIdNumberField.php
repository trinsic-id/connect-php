...
/**
 * KenyaNidMatch2NationalIdNumberField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class KenyaNidMatch2NationalIdNumberField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'KenyaNidMatch2NationalIdNumberField';
     ...
     * Sets outcome
     *
     * @param string|null $outcome The outcome of verifying the national ID number against the Integrated Population Registration System (IPRS).              Possible values: - Verified - Not Verified - Not Done - Issuer Unavailable - Not Returned
     *
     * @return self
     */
