...
class KenyaNidMatch2DateOfBirthField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets outcome
     *
     * @param string $outcome The outcome of comparing the submitted date of birth against the Integrated Population Registration System (IPRS).              Possible values: - Exact Match - Partial Match - Transposed - No Match - Not Returned
     *
     * @return self
     */
