...
/**
 * KenyaNidMatch2DateOfBirthField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class KenyaNidMatch2DateOfBirthField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'KenyaNidMatch2DateOfBirthField';
     ...
     * Sets outcome
     *
     * @param string|null $outcome The outcome of comparing the submitted date of birth against the Integrated Population Registration System (IPRS).              Possible values: - Exact Match - Partial Match - Transposed - No Match - Not Returned
     *
     * @return self
     */
