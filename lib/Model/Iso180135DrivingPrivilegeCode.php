...
/**
 * Iso180135DrivingPrivilegeCode Class Doc Comment
 *
 * @category Class
 ...
 */
class Iso180135DrivingPrivilegeCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Iso180135DrivingPrivilegeCode';
     ...
     * Sets sign
     *
     * @param string|null $sign Optional comparison sign applied to the code's value.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string|null $value Optional value applied to the code.
     *
     * @return self
     */
