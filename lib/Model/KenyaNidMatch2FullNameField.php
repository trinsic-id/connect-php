...
class KenyaNidMatch2FullNameField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets outcome
     *
     * @param string $outcome The outcome of comparing the submitted full name against the Integrated Population Registration System (IPRS).              Possible values: - Exact Match - Partial Match - Transposed - No Match - Not Returned
     *
     * @return self
     */
