...
/**
 * IndiaDigilockerAadhaarMatchDateOfBirthField Class Doc Comment
 *
 * @category Class
 * @package  Trinsic\Api
 * @author   OpenAPI Generator team
 ...
 */
class IndiaDigilockerAadhaarMatchDateOfBirthField implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IndiaDigilockerAadhaarMatchDateOfBirthField';
     ...
     * Sets input_value
     *
     * @param \DateTime|null $input_value The date of birth submitted for this check, as provided in the match input.
     *
     * @return self
     */
     ...
     * Sets outcome
     *
     * @param bool|null $outcome Whether the submitted date of birth matched the issuer record for this session.
     *
     * @return self
     */
