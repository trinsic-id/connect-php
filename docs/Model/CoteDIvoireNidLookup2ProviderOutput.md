...
------------ | ------------- | ------------- | -------------
**full_name** | **string** | Full name as returned by ONECI (National Civil Registry and Identification Office). | [optional]
**given_name** | **string** | Given name of the ID holder as returned by ONECI (National Civil Registry and Identification Office). | [optional]
**family_name** | **string** | Family name of the ID holder as returned by ONECI (National Civil Registry and Identification Office). | [optional]
**date_of_birth** | **\DateTime** | Date of birth as returned by ONECI (National Civil Registry and Identification Office). | [optional]
**sex** | **string** | Sex of the ID holder as returned by ONECI (National Civil Registry and Identification Office). Possible values: - Male - Female | [optional]
**nationality** | **string** | Nationality as ISO 3166-1 alpha-2 country code (e.g. \&quot;CI\&quot; for Côte d&#39;Ivoire). | [optional]
