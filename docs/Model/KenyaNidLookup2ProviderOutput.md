...
------------ | ------------- | ------------- | -------------
**first_name** | **string** | The first name (given name) of the ID holder as recorded in IPRS. | [optional]
**surname** | **string** | The surname (family name) of the ID holder as recorded in IPRS. | [optional]
**other_name** | **string** | The other name (middle name) of the ID holder as recorded in IPRS. | [optional]
**sex** | **string** | The sex of the ID holder as recorded on the National ID.              Possible values: - Male - Female | [optional]
