...
------------ | ------------- | ------------- | -------------
**national_id_number** | [**\Trinsic\Api\Model\IndonesiaDukcapilMatchNationalIdNumberField**](IndonesiaDukcapilMatchNationalIdNumberField.md) | NIK submitted for this Dukcapil match and the assessment result returned for that value. | [optional]
**full_name** | [**\Trinsic\Api\Model\IndonesiaDukcapilMatchFullNameField**](IndonesiaDukcapilMatchFullNameField.md) | Full name submitted for this Dukcapil match and the assessment result returned for that value. | [optional]
**date_of_birth** | [**\Trinsic\Api\Model\IndonesiaDukcapilMatchDateOfBirthField**](IndonesiaDukcapilMatchDateOfBirthField.md) | Date of birth submitted for this Dukcapil match and the assessment result returned for that value. | [optional]
...
**sex_national_id_number** | **string** | Sex extracted from the birth-day portion of the submitted NIK number.              Known values: - Male: The encoded day value is 40 or lower. - Female: The encoded day value is greater than 40. | [optional]
**serial_number** | **string** | Four-digit issuance serial number extracted from digits 13-16 of the submitted NIK number. | [optional]
...
**consent_given_at** | **\DateTime** | The consent timestamp submitted for this verification. | [optional]
