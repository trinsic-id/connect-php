...
------------ | ------------- | ------------- | -------------
**full_name** | **string** | Full name as it appears on the CI (Cédula de Identidad). | [optional]
**given_name** | **string** | Given name(s) of the holder as they appear on the CI (Cédula de Identidad). | [optional]
**family_name** | **string** | Family name(s) of the holder (paternal and maternal) as they appear on the CI (Cédula de Identidad). | [optional]
**date_of_birth** | **\DateTime** | Date of birth as recorded in official Bolivian identity records (RUI — Registro Único de Identificación). | [optional]
