...
------------ | ------------- | ------------- | -------------
**full_name** | **string** | Full name from Tribunal Electoral records. | [optional]
**given_name** | **string** | Given name(s) from Tribunal Electoral records. | [optional]
**family_name** | **string** | Family name(s) from Tribunal Electoral records. | [optional]
...
**nationality_or_residence_type** | **string** | Inferred from DocumentNumber. Values are nationality or residence category.              Possible values: - BornInPanama - ForeignNational - BornAbroad - Naturalized - LegacyNumber - Indigenous - Unknown (we were unable to determine the category) | [optional]
