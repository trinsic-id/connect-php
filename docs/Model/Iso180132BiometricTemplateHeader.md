...
------------ | ------------- | ------------- | -------------
**patron_header_version** | **int** | Patron header version (defaults to 0x0101). |
...
**biometric_data_block_format_owner** | **int** | Format owner of the biometric data block. |
**biometric_data_block_format_type** | **int** | Format type of the biometric data block. |
