...
**logo_url** | **string** | A URL pointing to the logo on Trinsic&#39;s CDN.              It may be a PNG, JPG, or SVG image. |
**dark_mode_logo_url** | **string** | An optional URL pointing to a dark mode logo on Trinsic&#39;s CDN.              It may be a PNG, JPG, or SVG image. If omitted, use LogoUrl in dark mode. | [optional]
