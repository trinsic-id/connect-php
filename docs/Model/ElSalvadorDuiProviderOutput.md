...
------------ | ------------- | ------------- | -------------
**full_name** | **string** | Full name as it appears on the DUI (Documento Único de Identidad), as returned by Verifik from official records administered by the Registro Nacional de las Personas Naturales (RNPN). | [optional]
...
**date_of_birth** | **\DateTime** | The date of birth that was supplied for the lookup and confirmed as matching the DUI record. | [optional]
